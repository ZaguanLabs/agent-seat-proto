...
| 0.1.3 / revision 5 | 0.1.4 | `agent-seat-x11` 0.1.21 / Tier 0 core plus Tier 0.5 input; Settings 0.1.6 | Linux, released Openbox 3.6.1 / isolated Xvfb | Target-relative pointer movement and primary click, covering-window refusal, focus-owner refusal, live-keymap text delivery, separate pointer/keyboard grants, disabled-seat opening denial, generation revocation, and absence of a `human_activity` claim verified; no root, broker, evdev, uinput, or input-group dependency |
