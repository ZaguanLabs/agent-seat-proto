...
- [Local JSON binding, wire revision 8](specification.md)
...
- [Registry custody](registries.md) and the
  [machine-readable projection](registry-v1.json)
- [Conformance report format](conformance-report.md), its
...
- [Standalone X11 Tier 0.5 input profile v3](profiles/x11-tier0.5-input-v3.md)
- [X11 obscured-client capture profile v2](profiles/x11-obscured-capture-v2.md)
